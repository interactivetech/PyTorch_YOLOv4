...
OUTPUT_DIR=/nvmefs1/andrew.mendez/fmv_subset_preds

mkdir $OUTPUT_DIR
echo "Created $OUTPUT_DIR"

python detect.py --weights /nvmefs1/andrew.mendez/yolov4_train_runs/fmv_train_subset_exp/weights/best.pt \
  --source $SOURCE_DIR \
  --output $OUTPUT_DIR \
  --img-size 640 \
  --conf-thres 0.4 \
